{
	...
	addBundle:[
		...
		{file:"bundle-song-fifth.js",onLoad:function(load,res){ addMarkerToSong(song[res.setObject[0].property]) }},
		{file:"bundle-song-skee.js",onLoad:function(load,res){ addMarkerToSong(song[res.setObject[0].property]) }},
		{file:"bundle-song-demo.js",onLoad:function(load,res){ addMarkerToSong(song[res.setObject[0].property]) }},
		
		// Loading the staff roll (is autogenerated from the loaded songs. Have a look to the resources file) ...
		{file:"bundle-credits.js"}
