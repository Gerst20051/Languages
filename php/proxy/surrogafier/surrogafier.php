<?php
# CONFIG {{{
define('DEFAULT_SIMPLE',false);# Default to simple mode when the page is loaded. [false]
define('FORCE_SIMPLE',false);# Force the page to always be in simple mode (no advanced mode option). [false]
define('SIMPLE_MODE_URLWIDTH','300px');# Width for the URL box when in simple mode (CSS "width" attribute). [300px]
define('DEFAULT_TUNNEL_PIP','');# Default value for tunnel server. []
define('DEFAULT_TUNNEL_PPORT','');# Default value for tunnel port. []
define('FORCE_DEFAULT_TUNNEL',true);# Should the tunnel fields be displayed? "false" value here will force the defaults above [true]
define('DEFAULT_URL_FORM',true);# Default value for "Persistent URL" checkbox [true]
define('DEFAULT_REMOVE_COOKIES',false);# Default value for "Remove Cookies" checkbox [false]
define('DEFAULT_REMOVE_REFERER',false);# Default value for "Remove Referer Field" checkbox [false]
define('DEFAULT_REMOVE_SCRIPTS',false);# Default value for "Remove Scripts" checkbox [false]
define('DEFAULT_REMOVE_OBJECTS',false);# Default value for "Remove Objects" checkbox [false]
define('DEFAULT_ENCRYPT_URLS',false);# Default value for "Encrypt URLs" checkbox [false]
define('DEFAULT_ENCRYPT_COOKS',false);# Default value for "Encrypt Cookies" checkbox [false]
...
define('MAXIMUM_URL_LENGTH',500);# 500 is the most reasonable number I could come up with as a maximum URL length limit
define('TIME_LIMIT',10);# Time limit in seconds for a single request and parse. [10]
define('DNS_CACHE_EXPIRE',10);# Time limit in minutes for a DNS entry to be kept in the cache. [10]
define('GZIP_PROXY_USER',false);# Use gzip (if possible) to compress the connection between the proxy and the user (less bandwidth, more CPU) [false]
define('GZIP_PROXY_SERVER',false);# Use gzip (if possible) to compress the connection between the proxy and the server (less bandwidth, more CPU) [false]
...
# HTTPS connection.  If you are, then 'https' is used as the PROTO value, otherwise 'http' is used.
# define('PROTO','http');
