...
if (isset($url_action)) {
	...
	else echo 'Function does not exist, request terminated';
}
...
function errMes($errno) {
	switch ($errno) {
		case 0: break;
		case 1: echo 'The username or password you entered is incorrect'; break;
...
function logOut() {
	...
	} else header("Location: ?action=logIn", TRUE, 301);
