<?php
//This is an example php 4.0 or > API code for implementation on a music site.    
//You can include this file inside your existing php code and just call out       
//the settings before it or you can modify this file to fit your needs.           
//All code provided here is custom made to the lyricsfly.com API interface         
//for the XML data retrieved from the database.                                    
//The code is freely available and no acknowledgment needs to be made on the      
//html page itself. You must however follow requirements with          
//lyricsfly.com API. Please see http://lyricsfly.com/api/ for more                
//details on API documentation.                                       
//                                                                                
//Release version 1.2
//Added filtering for special characters                                  
//                                                                                
//Release version: 1.1
//Added url encoding of artist & title
//
//Release version: 1.0
//First version                                                            
