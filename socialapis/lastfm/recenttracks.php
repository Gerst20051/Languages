<?php
$username = "andrewmofizzy";
$amount = 10;// Amount of data to be shown (not more than 10)
...
function lastfm_recenttracks($lastfm_username, $amount = 5) {
	...
	while ($i < $amount) {
		...
		$temp[$i][0] = $pieces[$i][1];
		// I saved the other part of the track info (track, artist) to $temp[$i][0] for later to use substr. Because some songs may have " - " something like "Oh God - Please Help me!"
