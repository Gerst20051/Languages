...
document.write('<tr class="istart_dark" onClick="' + "showHideLayer('mpspwindowsvista','visible')" + '"> <td width="20"><img src="../images/icons/menu/links/pspwindowsvista.png" width="20" height="20" border="0"></td><td><a href="#" class="aistart_dark">PSP Windows</a></td><td><img src="../images/arrow.gif" width="10" height="18"></td></tr>');
