...
Shortcut("My PSP","1","../apps/mypsp/index.htm","../images/icons/mypsp.png",0);
Shortcut("Internet","1","../apps/internet/index.htm","../images/icons/internet.png",0);
Shortcut("Text Editor","1","../apps/texteditor/index.htm","../images/icons/texteditor.png",0);
Shortcut("Calculator","1","../apps/calculator/index.htm","../images/icons/calculator.png",0);
