 ...
 *
 * $Revision: 5943 $
 * $Id: help_plugin.cpp 5943 2009-11-29 16:42:47Z killerbot $
 * $HeadURL: svn+ssh://jenslody@svn.berlios.de/svnroot/repos/codeblocks/trunk/src/plugins/contrib/help_plugin/help_plugin.cpp $
 */
